...
TraversalWrapper.prototype.copySplit = function () {
  var args = Array.prototype.slice.call(arguments).map(this._javify.bind(this));
...
function pipePromiseJsifyWrap(op) {
  return function () {
    var self = this;
    var argPair = this.gremlin.extractArguments(Array.prototype.slice.call(arguments));
    dlog('pipePromiseJsifyWrap(%s)', op, argPair, this.traversal[op]);
    return Q.npost(this.traversal, op, argPair.args)
      .then(function (res) {
        var jres = self._jsify(res);
        dlog('pipePromiseJsifyWrap(%s)(result) = ', res, jres);
        return jres;
      })
...
// TraversalWrapper.prototype.count = pipePromiseJsifyWrap('count');

// TraversalWrapper.prototype.iterate = pipePromiseWrap('iterate');
TraversalWrapper.prototype.iterator = pipePromiseWrap('iterator');
TraversalWrapper.prototype.hasNext = pipePromiseWrap('hasNext');
TraversalWrapper.prototype.next = pipePromiseJsifyWrap('next');
TraversalWrapper.prototype.fill = pipePromiseWrap('fill');
TraversalWrapper.prototype.enablePath = pipePromiseWrap('enablePath');
TraversalWrapper.prototype.optimize = pipePromiseWrap('optimize');
TraversalWrapper.prototype.remove = pipePromiseWrap('remove');
TraversalWrapper.prototype.reset = pipePromiseWrap('reset');
TraversalWrapper.prototype.getCurrentPath = pipePromiseWrap('getCurrentPath');
TraversalWrapper.prototype.getStarts = pipePromiseWrap('getStarts');
TraversalWrapper.prototype.get = pipePromiseWrap('get');
TraversalWrapper.prototype.equals = pipePromiseWrap('equals');
TraversalWrapper.prototype.size = pipePromiseWrap('size');
TraversalWrapper.prototype.toList = pipePromiseWrap('toList');
