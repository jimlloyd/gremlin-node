...
var TraversalWrapper = module.exports = function (gremlin, traversal) {
  assert.ok(traversal);
  // Both Traversal and __ (class) have a compatible shape.
  assert.ok(gremlin.isType(traversal, 'com.tinkerpop.gremlin.process.Traversal') ||
            ('class' in traversal &&
             traversal.class.getNameSync() === 'com.tinkerpop.gremlin.process.graph.traversal.__'));
...
TraversalWrapper.prototype.option = function () {
  var args = Array.prototype.slice.call(arguments).map(this.gremlin._javify.bind(this.gremlin));
  return this.add('option', args);
};

TraversalWrapper.prototype.coalesce = function () {
  var args = Array.prototype.slice.call(arguments).map(this.gremlin._javify.bind(this.gremlin));
  this.gremlin._parseVarargs(args, 'com.tinkerpop.gremlin.process.Traversal');
  return this.add('coalesce', args);
};
...
TraversalWrapper.prototype.repeat = function () {
  var args = Array.prototype.slice.call(arguments).map(this.gremlin._javify.bind(this.gremlin));
  return this.add('repeat', args);
};

TraversalWrapper.prototype.until = function () {
  var args = Array.prototype.slice.call(arguments).map(this.gremlin._javify.bind(this.gremlin));
  return this.add('until', args);
};

TraversalWrapper.prototype.times = function () {
  var args = Array.prototype.slice.call(arguments);
  return this.add('times', args);
};
...
TraversalWrapper.prototype.subgraph = function () {
  var args = Array.prototype.slice.call(arguments);
  return this.add('subgraph', args);
};
...
// We handle the variadic argument by collapsing multiple args into a single array arg.
